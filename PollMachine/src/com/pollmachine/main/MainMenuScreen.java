...
public class MainMenuScreen implements Runnable {
	...
	private void createComponents(Container container) {
		...
		JLabel pollsAnswered = new JLabel("Polls answered: " + user.getAnsweredPolls());
		...
		JLabel pollsCreated = new JLabel("Polls created: " + user.getCreatedPolls());
		...
		FixedColorButton answer= new FixedColorButton("Answer hot polls" , "blue");
		constraints.gridx = 0;
		constraints.gridy = 2;
		constraints.gridwidth = 10;
		...
		FixedColorButton create = new FixedColorButton("Create new poll" , "red");
		constraints.gridx = 0;
		constraints.gridy = 3;
		constraints.gridwidth = 10;
		constraints.ipady = 50;
		...
		FixedColorButton search = new FixedColorButton("Search a poll" , "red");
		constraints.gridx = 0;
		constraints.gridy = 4;
		constraints.gridwidth = 10;
		constraints.ipady = 50;
		...
		FixedColorButton logout = new FixedColorButton("Create a new poll" , "red");
		constraints.gridx = 0;
		constraints.gridy = 5;
		constraints.gridwidth = 10;
		constraints.ipady = 50;
